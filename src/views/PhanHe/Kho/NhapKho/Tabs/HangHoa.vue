...
export default {
  ...
  data() {
    return {
      fields: this.lodash.getTableFields(Documents.hachtoan.nhapkho),
      dataInput: {},
    };
  },
  computed: {
    ...mapGetters({
      chungtu: "chungtu.nhapkho.selected",
      hachtoan: "hachtoan.nhapkho.selected",
  ...
  methods: {
    ...
    create() {
      ...
      this.$store.dispatch(
        "chungtu.nhapkho.hachtoan.tienhang.create",
        this.dataInput
      );
    },
    save() {
      this.$store.dispatch(
        "chungtu.nhapkho.hachtoan.tienhang.update",
        this.dataInput
      );
    },
    destroy() {
      this.$store.dispatch(
        "chungtu.nhapkho.hachtoan.tienhang.delete",
        this.dataInput.id
      );
    },
  },
