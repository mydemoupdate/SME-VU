...
export default {
  ...
  data() {
    return {
      fields: this.lodash.getTableFields(Documents.hachtoan.xuatkho),
      dataInput: {},
    };
  },
  computed: {
    ...mapGetters({
      chungtu: "chungtu.xuatkho.selected",
      hachtoan: "hachtoan.xuatkho.selected",
  ...
  methods: {
    ...
    create() {
      ...
      this.$store.dispatch(
        "chungtu.xuatkho.hachtoan.tienhang.create",
        this.dataInput
      );
    },
    save() {
      this.$store.dispatch(
        "chungtu.xuatkho.hachtoan.tienhang.update",
        this.dataInput
      );
    },
    destroy() {
      this.$store.dispatch(
        "chungtu.xuatkho.hachtoan.tienhang.delete",
        this.dataInput.id
      );
    },
  },
