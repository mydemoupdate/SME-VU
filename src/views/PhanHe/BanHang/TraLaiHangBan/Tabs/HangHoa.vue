...
export default {
  ...
  data() {
    return {
      fields: this.lodash.getTableFields(Documents.hachtoan.tralaihangban),
      dataInput: {},
    };
  },
  computed: {
    ...mapGetters({
      chungtu: "chungtu.tralaihangban.selected",
      hachtoan: "hachtoan.tralaihangban.selected",
  ...
  methods: {
    ...
    create() {
      ...
      this.$store.dispatch(
        "chungtu.tralaihangban.hachtoan.tienhang.create",
        this.dataInput
      );
    },
    save() {
      this.$store.dispatch(
        "chungtu.tralaihangban.hachtoan.tienhang.update",
        this.dataInput
      );
    },
    destroy() {
      this.$store.dispatch(
        "chungtu.tralaihangban.hachtoan.tienhang.delete",
        this.dataInput.id
      );
    },
  },
