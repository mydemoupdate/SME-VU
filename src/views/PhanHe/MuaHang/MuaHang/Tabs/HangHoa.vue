...
export default {
  ...
  data() {
    return {
      fields: this.lodash.getTableFields(Documents.hachtoan.muahang),
      dataInput: {},
    };
  },
  computed: {
    ...mapGetters({
      chungtu: "chungtu.muahang.selected",
      hachtoan: "hachtoan.muahang.selected",
  ...
  methods: {
    ...
    create() {
      ...
      this.$store.dispatch(
        "chungtu.muahang.hachtoan.tienhang.create",
        this.dataInput
      );
    },
    save() {
      this.$store.dispatch(
        "chungtu.muahang.hachtoan.tienhang.update",
        this.dataInput
      );
    },
    destroy() {
      this.$store.dispatch(
        "chungtu.muahang.hachtoan.tienhang.delete",
        this.dataInput.id
      );
    },
  },
