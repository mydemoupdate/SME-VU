...
export default {
  ...
  computed: {
    ...mapGetters({
      obj: "chungtu.giamgiahangmua.selected",
  ...
  methods: {
    create() {
      this.$store.dispatch("chungtu.giamgiahangmua.create", {
        ...this.obj,
        hachtoantienhang: [],
        hachtoanthuegtgt: [],
      });
    ...
    save() {
      this.$store.dispatch("chungtu.giamgiahangmua.update", this.obj);
    },
    destroy() {
      this.$store.dispatch("chungtu.giamgiahangmua.delete");
    },
  },
};
</script>
