...
export default {
  ...
  data() {
    return {
      fields: this.lodash.getTableFields(Documents.hachtoan.chitiengui),
      dataInput: {},
    };
  },
  computed: {
    ...mapGetters({
      chungtu: "chungtu.chitiengui.selected",
      hachtoan: "hachtoan.chitiengui.selected",
  ...
  methods: {
    ...
    create() {
      ...
      this.$store.dispatch(
        "chungtu.chitiengui.hachtoan.create",
        this.dataInput
      );
    },
    save() {
      this.$store.dispatch(
        "chungtu.chitiengui.hachtoan.update",
        this.dataInput
      );
    },
    destroy() {
      this.$store.dispatch(
        "chungtu.chitiengui.hachtoan.delete",
        this.dataInput.id
      );
    },
  },
